...
def plot_track(x_values: list[float], y_values: list[float], headings: list[float], goals=[[0,0]]) -> None:
    ...
    plt.scatter(goals.x,goals.y, c="red")
...
def plot(track: Track, goals) -> None:
    ...
    # Plot the track
    plot_track(x_values, y_values, headings, goals)