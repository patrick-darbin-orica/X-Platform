...
async def main(service_config_path: Path, store: bool) -> None:
    ...
    pto_rpm_read_req = amiga_v6_pb2.ConfigRequestReply(
        node_id=DASHBOARD_NODE_ID,
        op_id=amiga_v6_pb2.ConfigOperationIds.READ,
        val_id=amiga_v6_pb2.ConfigValueIds.PTO_CUR_DEV,
        unit=amiga_v6_pb2.ConfigValueUnits.RPM,
    )

    pto_rpm_write_req = amiga_v6_pb2.ConfigRequestReply(
        node_id=DASHBOARD_NODE_ID,
        op_id=amiga_v6_pb2.ConfigOperationIds.WRITE,
        val_id=amiga_v6_pb2.ConfigValueIds.PTO_CUR_RPM ,
        unit=amiga_v6_pb2.ConfigValueUnits.RPM,
        double_value=5.0,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--service-config", type=Path, default="dashboard_service_config", help="The canbus service config.")
