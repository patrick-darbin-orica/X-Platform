...
def detect_and_push_encoder_data():
    ...
    try:
        while True:
            ...
            print(f"Net counts: {counter_value}, Revolutions: {revolutions}")

            data_array = [timestamp, counter_value, revolutions, volt_ain0]
